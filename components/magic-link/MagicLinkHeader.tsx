...
export function MagicLinkHeader({ email }: { email?: string | null }) {
  return (
    <header className="shrink-0 bg-[#115e59] text-white">
      <div className="flex w-full items-center justify-between gap-4 px-5 py-3">
        <div className="flex items-center gap-4">
          <Link href="/magic-link" className="text-lg font-semibold tracking-tight">
            Le magic link
          </Link>
